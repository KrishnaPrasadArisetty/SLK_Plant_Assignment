require.config({
    paths: {
        ...
        tabulator: 'https://unpkg.com/tabulator-tables@6.0.0/dist/js/tabulator.min',
        tabulatorCss: 'https://unpkg.com/tabulator-tables@6.0.0/dist/css/tabulator.min' // Path for Tabulator CSS
    },
    shim: {
